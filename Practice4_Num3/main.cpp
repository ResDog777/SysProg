...
int main()
{
    ...
    {
        cout << "Иванов is in the my_String." << endl;
    }
    if (!(my_String.In_Set("Ситников")))
    {
        cout << "Ситников is not in the my_String." << endl;
    }
    my_String = my_String + "Хорин";
